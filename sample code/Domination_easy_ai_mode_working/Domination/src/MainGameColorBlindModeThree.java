...
public class MainGameColorBlindModeThree extends GameDisplay implements ActionListener{
	...
	MainGameColorBlindModeThree(int numberOfHumanPlayers, String player1,String player2,String player3,String player4, int botDifficultyLevel, int colorMode){

...
public class MainGameColorBlindModeOne extends GameDisplay implements ActionListener{
	...
	MainGameColorBlindModeOne(int numberOfHumanPlayers, String player1,String player2,String player3,String player4, int botDifficultyLevel, int colorMode){
		this.numberOfHumanPlayers = numberOfHumanPlayers;
		this.colorOne = new Color(1,48,162);
        this.colorTwo = new Color(98,91,7);
        this.colorThree = new Color(111,130,206);
        this.colorFour = new Color(220,201,1);
	...
	public void setPiecesOnBoard() {
		...
		for (int row=0; row<8;row++) {
			for(int column=0; column<8;column++) {
				...
				if (((panelLayout)super.panelArray[row][column]).getBackground()==colorOne || ((panelLayout)super.panelArray[row][column]).getBackground()==colorTwo) {

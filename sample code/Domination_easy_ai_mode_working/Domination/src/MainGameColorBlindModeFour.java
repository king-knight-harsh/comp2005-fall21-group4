...
public class MainGameColorBlindModeFour extends GameDisplay implements ActionListener{
	...
	MainGameColorBlindModeFour(int numberOfHumanPlayers, String player1,String player2,String player3,String player4, int botDifficultyLevel, int colorMode){
